...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "RAHMAN ~6fhx1AJC#h-ClNzXV_1_oaqLHrXGcu-PoaOMqvHdqgnBW0axSlBQ",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Rᴀʜᴍᴀɴ Tᴇᴄʜ",           // Owner's name
